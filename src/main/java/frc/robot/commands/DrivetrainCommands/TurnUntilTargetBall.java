...
public class TurnUntilTargetBall extends CommandBase {
  ...
  public TurnUntilTargetBall(double speed) {
    // Use addRequirements() here to declare subsystem dependencies.
    mDrivetrain = RobotContainer.mDrivetrain;
    turnSpeed = speed;
    isTargetFoundEntry =
        NetworkTableInstance.getDefault().getTable("limelight-balls").getEntry("tv");
